...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 03, 2020 at 01:53 AM
...
INSERT INTO `app_dataset` (`id`, `firstname`, `lastname`, `nid`, `mobile`, `lastseen`) VALUES
(1, 'T R', 'Nayan', '6524859325462', '+8801751996786', '2020-10-02 19:31:21+00:00'),
(2, 'T R', 'Nayan', '652485932462', '+8801751996787', 'not found'),
(3, 'T R', 'Nayan', '652485932462', '+8801726335720', '2020-10-02 18:42:17+00:00'),
(4, 'T R', 'Nayan', '652485932462', '+8801245859625', 'not found');
...
(4, 'Screenshot _5_.png', '345368', '2020-03-29', '/user_data/1/Screenshot%20_5_.png', 0, 1, 0, NULL),
...
(33, 'README.md', '2583', '2020-09-30', '/user_data/17/README.md', 0, 17, 0, NULL),
(34, 'README.md', '2583', '2020-10-01', '/user_data/1/README.md', 0, 1, 0, NULL);
...
CREATE TABLE `app_user` (
  ...
  `user_keyword` longtext DEFAULT NULL,
  `user_url` longtext DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `app_user` (`id`, `user_email`, `user_password`, `user_vault_psw`, `user_name`, `user_keyword`, `user_url`) VALUES
(1, 'admin@example.com', '25d55ad283aa400af464c76d713c07ad', '81dc9bdb52d04dc20036dbd8313ed055', 'Thomas Albert', 'Cyber Criminal ', 'www.thomash.com'),
(13, 'yash49@gmail.com', '25d55ad283aa400af464c76d713c07ad', '', NULL, '', ''),
(16, 'admin@crudbooster.com', 'e10adc3949ba59abbe56e057f20f883e', '', '', '', ''),
(17, 'jacacev519@debsmail.com', '25f9e794323b453885f5181f1b624d0b', '', '', '', '');
...
--
-- Dumping data for table `app_verification`
--

INSERT INTO `app_verification` (`id`, `otp`, `user_id`) VALUES
(15, 522503, 16);
...
(1, 'pbkdf2_sha256$180000$iweMeWlISdH8$aaQApufLLW4Igtho3k2xwfENY5qmTxe+zQgg6p50Rco=', '2020-09-30 13:28:07.677070', 1, 'admin', '', '', 'admin@example.com', 1, 1, '2020-09-30 13:27:24.691644');
...
('5d3i76d207a4tn8vqcq73e554y8f8k2k', '', '2020-10-14 20:56:04.594156'),
...
('f8lk8duouk4wj4q0aobqyqqfxftxgllu', 'ZWE5ZWY3NWJmZTFkMWFlODQwOWUzMDBkYjZmYTkxYmU2N2U1MjI2ZTp7fQ==', '2020-10-15 09:44:23.274437'),
...
--
-- Indexes for table `app_dataset`
--
ALTER TABLE `app_dataset`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `app_dataset`
--
ALTER TABLE `app_dataset`
